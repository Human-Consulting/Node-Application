import { Box, Button, Dialog, IconButton, InputAdornment, Stack, TextField, Typography } from "@mui/material";
...
import { putSenhaUsuario } from "../../Utils/cruds/CrudsUsuario";

interface ModalEditarSenhaUsuarioProps {
    open: boolean;
    onClose: () => void;
    idUsuario?: number | string | null;
    atualizarUsuarios: (page?: number, nome?: string | null) => void | Promise<unknown>;
    editarSenhaUsuario: () => void;
}

const ModalEditarSenhaUsuario = ({ open, onClose, idUsuario, atualizarUsuarios, editarSenhaUsuario }: ModalEditarSenhaUsuarioProps) => {
