    ...
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="xs">
      <Content sx={{ background: theme.palette.background.paper }}>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          ...
          <Close onClick={onClose} sx={{ cursor: "pointer", color: theme.palette.text.primary }} />
        </Box>
      ...
      <Actions>
        {empresa == null ? (
          <Button variant="contained" onClick={handlePostEmpresa} endIcon={<Send />}>
            Adicionar
          </Button>
        ) : (
          <>
            ...
            <Button variant="contained" onClick={handlePutEmpresa} endIcon={<Send />} sx={{ flex: 1 }}>
              Salvar Alterações
            </Button>
          </>
        )}
