...
const BurndownChart = ({ dados, idSprint }: BurndownChartProps) => {
    if (!dados || !dados.sprints || dados.sprints.length === 0) return null;
    const hoje = dayjs();
