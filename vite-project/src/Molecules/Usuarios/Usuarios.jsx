...
const Usuarios = ({ toogleLateralBar, usuarios, atualizarUsuarios }) => {
  ...
  return (
    <UsuariosBody style={{ position: 'relative', zIndex: 0 }}>
      ...
      <Typography variant="h3" mt={3} mb={2} sx={{ display: 'flex', alignItems: 'center', fontFamily: "Bebas Neue" }}><ArrowCircleLeftOutlinedIcon sx={{ cursor: 'pointer', fontSize: '45px', marginRight: 1 }} onClick={handleOpenProject} />Gerenciamento da {idEmpresa == 1 ? "Human Consulting" : nomeEmpresa}</Typography>
