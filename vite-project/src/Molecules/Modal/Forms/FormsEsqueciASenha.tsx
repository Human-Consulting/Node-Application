...
import { putEsqueciASenhaUsuario } from "../../../Utils/cruds/CrudsUsuario";

interface FormsEsqueciASenhaProps {
    id: number | string | null;
    codigo: string | null;
    toggleModal: () => void;
}

const FormsEditarSenhaUsuario = ({ id, codigo, toggleModal }: FormsEsqueciASenhaProps) => {
    ...
    const handlePutUsuario = async () => {
        ...
        const body = { senhaAtualizada, codigo };
