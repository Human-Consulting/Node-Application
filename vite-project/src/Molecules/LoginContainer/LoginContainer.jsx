      ...
      <ContainerFrase>
        <Stack sx={{ width: '72%', gap: '2rem' }}>
          ...
          <p style={{ fontSize: '24px', fontWeight: '300' }}>
            Sua ideia,{" "}
            <span style={{ fontWeight: 700 }}>nosso planejamento</span>, e a{" "}
            <span style={{ fontWeight: 700 }}>execução que garante o sucesso</span>{" "}
            do seu{" "}
            <span style={{ fontWeight: 700 }}>projeto</span>.
          </p>
        </Stack>
      </ContainerFrase>
