...
const FormsTask = ({ task, toogleModal, atualizarSprints, atualizarProjetos, usuarios, setUsuarios, idSprint }) => {
    ...
    const [checkboxes, setCheckboxes] = useState([
        { id: 1, label: 'Exemplo 1', checked: false },
    ]);
    ...
    return (
        <Stack direction="column" mb={2} >
            ...
            <Stack direction="row" justifyContent="space-between" mb={2} gap='50px' >
                ...
                <Box display="flex" flexDirection="column" alignItems="start" gap={2} p={2} borderRadius={2} flex='1' >

                    {checkboxes.map(cb => (
                        <Box key={cb.id} display="flex" alignItems="center" justifyContent="space-between" backgroundColor="#22272B" gap={1} width="100%">
