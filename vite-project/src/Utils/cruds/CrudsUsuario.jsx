...
export const putUsuario = async (modifiedUsuario, idUsuario) => {
  try {
    ...
    const res = await fetch(
      `${import.meta.env.VITE_ENDERECO_API}/usuarios/${idUsuario}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export const putSenhaUsuario = async (modifiedUsuario, idUsuario) => {
  try {
    ...
    const res = await fetch(
      ...
      }/usuarios/atualizarSenha/${idUsuario}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export const putEsqueciASenhaUsuario = async (modifiedUsuario, idUsuario) => {
  try {
    ...
    const res = await fetch(
      `${
        import.meta.env.VITE_ENDERECO_API
      }/usuarios/esqueciASenha/${idUsuario}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export const putCoresUsuario = async (modifiedUsuario, idUsuario) => {
  try {
    ...
    const res = await fetch(
      `${
        import.meta.env.VITE_ENDERECO_API
      }/usuarios/atualizarCores/${idUsuario}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export const uploadFile = async (file, toogleModal) => {
  ...
  try {
    const res = await fetch(
      "${import.meta.env.VITE_ENDERECO_API}/usuarios/upload",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getIdUsuario = async (email) => {
  try {
    const res = await fetch(
      `${import.meta.env.VITE_ENDERECO_API}/usuarios/emailExistente/${email}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const enviarCodigo = async (body) => {
  try {
    ...
    // Usa o endpoint correto para reset de senha
    const res = await fetch(
      `${import.meta.env.VITE_ENDERECO_API}/auth/reset-senha/solicitar`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
